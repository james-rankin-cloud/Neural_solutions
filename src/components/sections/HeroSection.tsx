...
const HeroSection = () => (
  <section className="relative min-h-screen flex items-center justify-center atmosphere grain overflow-hidden">
    <div className="absolute top-[15%] left-[10%] w-64 h-64 rounded-full bg-primary/[0.06] blur-3xl float" />
    <div className="absolute bottom-[20%] right-[15%] w-80 h-80 rounded-full bg-accent/[0.05] blur-3xl float-delayed" />
    <div className="absolute top-[40%] right-[25%] w-32 h-32 rounded-full bg-primary/[0.03] blur-2xl animate-drift" />

    <div
      className="absolute inset-0 opacity-[0.04]"
      style={{
        backgroundImage: "linear-gradient(hsl(262 70% 50% / 0.2) 1px, transparent 1px), linear-gradient(90deg, hsl(262 70% 50% / 0.2) 1px, transparent 1px)",

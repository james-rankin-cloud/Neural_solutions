    ...
    <div className="min-h-screen bg-background overflow-hidden">
      ...
      <section className="pt-32 pb-32 px-6 relative min-h-screen flex items-center">
        <div className="max-w-xl mx-auto w-full relative z-10">
          <ScrollReveal>
            <span className="font-sans text-xs uppercase tracking-wider text-muted-foreground mb-4 block">Get Started</span>
            <h1 className="font-sans text-4xl md:text-5xl font-medium tracking-tight text-foreground leading-tight mb-3">
              Get in Touch
            </h1>
            <p className="font-sans text-lg text-muted-foreground mb-4">Your choice: message us or book a call.</p>
            <p className="font-sans text-base text-muted-foreground mb-10 leading-relaxed">
              Send us a message for general inquiries, or schedule a dedicated call to discuss your AI automation needs in detail.
            </p>
          </ScrollReveal>

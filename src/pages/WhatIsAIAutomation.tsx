...
const WhatIsAIAutomation = () => {
  return (
    <>
      <Helmet>
        <title>AI Automation by Industry | Real Examples & Implementation | Neural Solutions</title>
        <meta
          name="description"
          content="Discover how AI automation transforms healthcare, real estate, legal, e-commerce, professional services, and home services. Real use cases with implementation details."
        />
        <meta
          name="keywords"
        ...
        />
        <link rel="canonical" href="https://www.neuralsolutions.cloud/resources/what-is-ai-automation" />
        <meta property="og:title" content="AI Automation by Industry | Real Examples & Implementation" />
        <meta property="og:description" content="Discover how AI automation transforms healthcare, real estate, legal, e-commerce, professional services, and home services." />
          ...
          <ScrollReveal>
            <div className="text-center space-y-6">
              ...
              <p className="font-sans text-xl md:text-2xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
                Real examples, specific use cases, and implementation blueprints for industries we serve.
              </p>
            </div>
          </ScrollReveal>
        </div>
          ...
          <ScrollReveal>
            <div className="text-center space-y-8">
              ...
              <p className="font-sans text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
                Every business is different. Book a free audit to get a custom automation plan tailored to your specific workflows and goals.
              </p>
      ...
      <section className="py-20 px-6 bg-background">
        <div className="container max-w-4xl">
          <ScrollReveal>
            <h2 className="font-sans text-4xl font-medium tracking-tight text-foreground mb-12 text-center">
              Common Questions
            </h2>
          </ScrollReveal>
          ...
          <div className="space-y-6">
            <ScrollReveal delay={100}>
              <div className="bg-secondary/30 rounded-[1.25rem] p-8 border border-border">
                ...
                <p className="font-sans text-base text-muted-foreground mb-4 leading-relaxed">
                  Most projects range from $3,000-$25,000 depending on complexity, plus $200-$500/month for maintenance. Simple chatbots start around $3,000, while multi-system integrations can run $15,000-$50,000.
                </p>
                <p className="font-sans text-sm text-foreground font-medium">
                  Typical ROI achieved within 6-12 months through time savings and increased revenue.
                </p>
              </div>
            </ScrollReveal>
            ...
            <ScrollReveal delay={200}>
              <div className="bg-secondary/30 rounded-[1.25rem] p-8 border border-border">
                ...
                <p className="font-sans text-base text-muted-foreground leading-relaxed">
                  Simple projects: 2-4 weeks • Medium complexity: 4-8 weeks • Complex systems: 8-16 weeks. Timeline includes discovery, design, development, testing, training, and launch support.
                </p>
              </div>
            </ScrollReveal>
            ...
            <ScrollReveal delay={300}>
              <div className="bg-secondary/30 rounded-[1.25rem] p-8 border border-border">
                ...
                <p className="font-sans text-base text-muted-foreground mb-4 leading-relaxed">
                  No. AI handles repetitive tasks, freeing your team for higher-value work. Real outcome: employees shift from data entry to strategy and customer relationships. Teams become more productive without working longer hours.
                </p>
                <p className="font-sans text-sm text-foreground font-medium">
                  Think of AI as a productivity multiplier, not a replacement.
                </p>
              </div>
            </ScrollReveal>
            ...
            <ScrollReveal delay={400}>
              <div className="bg-secondary/30 rounded-[1.25rem] p-8 border border-border">
                ...
                <p className="font-sans text-base text-muted-foreground mb-3 leading-relaxed">
                  Yes. Modern AI automation connects to virtually any business software via APIs. Common integrations include:
                </p>
                <div className="grid grid-cols-2 md:grid-cols-3 gap-2 text-sm">
                  <span className="font-sans text-foreground">• CRMs (Salesforce, HubSpot)</span>
                  <span className="font-sans text-foreground">• Email (Gmail, Outlook)</span>
                  <span className="font-sans text-foreground">• Calendars (Google, Outlook)</span>
                  <span className="font-sans text-foreground">• Accounting (QuickBooks, Xero)</span>
                  <span className="font-sans text-foreground">• E-commerce (Shopify)</span>
                  <span className="font-sans text-foreground">• Project mgmt (Asana, Monday)</span>
                </div>
              </div>
            </ScrollReveal>
          </div>
          ...
          <ScrollReveal>
            <div className="space-y-6">
              ...
              <p className="font-sans text-lg leading-relaxed opacity-90">
                We're a Victoria, BC-based AI automation agency helping Canadian businesses automate repetitive work and scale efficiently. Our team combines software engineering expertise (Ericsson, UVic) with business acumen (Baker Tilly) to deliver practical, ROI-focused automation solutions.
              </p>
              <div className="pt-6 space-y-2">
                <p className="font-sans text-sm uppercase tracking-wider opacity-70">Real Results</p>
                <ul className="space-y-2">
                  <li className="font-sans text-base">• 6 integrated systems for Ageless Living™ (health & wellness)</li>
                  <li className="font-sans text-base">• Zero missed leads for Harrison Forbes Electrical (construction)</li>
                  <li className="font-sans text-base">• 50+ businesses automated across British Columbia and Canada</li>
                </ul>
              </div>
